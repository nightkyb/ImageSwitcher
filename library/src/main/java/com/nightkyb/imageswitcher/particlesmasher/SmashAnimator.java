...
import com.nightkyb.imageswitcher.Utils;
import com.nightkyb.imageswitcher.particlesmasher.particle.DropParticle;
import com.nightkyb.imageswitcher.particlesmasher.particle.ExplosionParticle;
import com.nightkyb.imageswitcher.particlesmasher.particle.FloatParticle;
import com.nightkyb.imageswitcher.particlesmasher.particle.Particle;

import java.util.Random;

public class SmashAnimator {
    public static final int STYLE_FLOAT_LEFT = 1,     // 飘落——>自左往右，逐列飘落
            STYLE_FLOAT_RIGHT = 2,                    // 飘落——>自右往左，逐列飘落
            STYLE_FLOAT_TOP = 3,                      // 飘落——>自上往下，逐行飘落
            STYLE_FLOAT_BOTTOM = 4,                   // 飘落——>自下往上，逐行飘落
            STYLE_DROP = 5,                           // 下落
            STYLE_EXPLOSION = 6;                      // 爆炸
    ...
    private int mRadius = Utils.dp2px(1);              // 粒子基础半径
     ...
     */
    void hideView(final View view, long startDelay) {
